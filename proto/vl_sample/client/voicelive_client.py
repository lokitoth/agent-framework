...
"""
FILE: voicelive_sample.py

DESCRIPTION:
    This sample demonstrates how to connect to an Azure AI Foundry hosted agent 
...
USAGE:
    ...
    Command-line arguments:
      --endpoint       The Azure VoiceLive endpoint (required)
      --agent-name     The name of your Azure AI Foundry agent (required)
      --project-name   The name of the Foundry project containing the agent (required)
"""
...
class AgentV2VoiceAssistant:
    ...
    async def _setup_session(self):
        ...
        interim_response_config = LlmInterimResponseConfig(latency_threshold_ms=500)
    ...
    async def _handle_event(self, event):
        ...
        if event.type == ServerEventType.SESSION_UPDATED:
            ...
            logger.debug("Received audio transcript delta: %s", event.delta)
...
def main(args: argparse.Namespace):
    ...
    # Start the assistant
    try:
        asyncio.run(run_assistant(args.endpoint, args.agent_name, args.project_name))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Agent V2 Voice Assistant with Azure VoiceLive SDK")
    parser.add_argument("--endpoint", required=True, help="The Azure VoiceLive endpoint")
    parser.add_argument("--agent-name", required=True, help="The name of your Azure AI Foundry agent")
    parser.add_argument("--project-name", required=True, help="The Foundry project containing the agent")
